...
background = pygame.image.load('back_flower.jpg')
fighter =  pygame.image.load('fighter.png')
missile = pygame.image.load('missile.png')
explosion = pygame.image.load('explosion.png')
butterfly_red = pygame.image.load('butterfly_red.png')
butterfly_yellow= pygame.image.load('butterfly_yellow.png')
butterfly_blue =pygame.image.load('butterfly_blue.png')
